...
def on_push_state(*args):
    ...
    draw.text((5, 100), icon_previous, font=font0w, fill=0)
    draw.text((70, 100), icon_sound, font=font0w, fill=0)
    draw.text((150, 100), icon_status, font=font0w, fill=0)
    draw.text((225, 100), icon_next, font=font0w, fill=0)
...
t3 = touch_area('touch_play', 80, 100)
