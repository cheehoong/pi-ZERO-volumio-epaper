...
draw.line((0, 0) + im2.size, fill=128)
draw.line((0, im.size[1], im2.size[0], 0), fill=128)
...
im3 = im2.transpose(method=Image.ROTATE_90)
epd.displayPartBaseImage(epd.getbuffer(im3))
epd.init(epd.PART_UPDATE)
